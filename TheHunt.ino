...
enum gameStates {SLAVE, MONSTER, CITIZEN, RESET, CLEARM, CLEARC, DETECTED, WIN, LOSE, KM, KC, KE, KWM, KWC};  //tile states
...
void winDisplayLoop() {
  setColorOnFace(GREEN, randomizer);                   
}

void loseDisplayLoop() {
  setColorOnFace(RED, randomizer);                        
}
